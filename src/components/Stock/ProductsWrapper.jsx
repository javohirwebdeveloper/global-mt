  ...
  return (
    ...
    >
      ...
      <section className="flex flex-col items-start justify-start w-[1310px] text-left text-sm text-teal font-h3 mq800:gap-[20px]">
        ...
        <div className="w-[397px] hidden mq770:flex flex-row items-start justify-start gap-[10px] max-w-full mq450:flex-wrap">
          <Button
            className="h-[41px] flex-1 min-w-[162px]"
            disableElevation
            variant="outlined"
        ...
        <div className="w-[1000px] flex flex-row items-start justify-between mq1290:hidden py-0 pr-5 pl-0 box-border max-w-full gap-[20px] mq800:flex-wrap">

   ...
   useEffect(() => {
    ...
    return (
      <div className="banner-container" data-aos="fade-right">
        <div className="carousels relative w-[1310px] h-[367px] top-[223px] left-[65px] rounded-[10px]">
          <Carousel
            ref={carouselRef}
            showArrows={false}
            showThumbs={false}
          ...
          >
              ...
              <div className="w-[100%] h-[100%] flex justify-end items-end">
                <div className="banner-clip-path h-[100%] w-[60%]">
                  <img
                    src={Banner3}
                    alt=""
                    className="object-cover w-full bottom-0 h-full"
                  />
                </div>
              </div>
              <div className="absolute w-[1250px] h-full top-0 left-[60px]">
                <div className="text-left absolute text-[30px] w-[538px] top-[31px] left-0 font-1440-h1 font-[number:var(--1440-h1-font-weight)] text-ws-j7-it tracking-[var(--1440-h1-letter-spacing)] leading-[var(--1440-h1-line-height)] [font-style:var(--1440-h1-font-style)]">
                  Фиброназофарингоскоп FN-38A
                  <br /> Гибкий фиброскоп для <br />
                  оториноларингологии
                  <br />
                </div>
              </div>
            ...
            <div className="carousel3 relative w-full h-[367px] bg-x-7rs-fx rounded-[10px] overflow-hidden">
              <div className="w-[100%] h-[100%] flex justify-end items-end">
                <div className="banner-clip-path h-[100%] w-[60%]">
                  <img
                    src={Banner1}
          ...
          <div className="arrows absolute w-[760px] h-full top-0 left-[490px] rounded-[10px_10px_10px_0px] overflow-hidden">
            <div className="h-full">
              <div className="flex w-[92px] h-[41px] items-center gap-2.5 relative top-[272px] left-[608px]">
                <div

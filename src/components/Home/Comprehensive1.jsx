const Comprehensive1 = ({ className = "", photo, prop }) => {
  return (
    <div
      className={`h-[579px] carousel-item w-[430px] flex flex-col items-start justify-start pt-0 px-0 pb-5 box-border relative gap-[20px] max-w-full text-left text-base text-[#202020] font-t1 ${className}`}
    >

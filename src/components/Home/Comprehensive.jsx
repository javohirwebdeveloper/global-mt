...
export const Comprehensive = () => {
  ...
  return (
    <div
      className={`max-w-[1440px] xl:mt-[150px] md:mt-[99px] sm:mt-[50px] mt-[40px] xl:px-[65px] sm:px-[20px] px-[15px] mx-auto bg-color overflow-hidden flex flex-col items-start justify-start gap-[41.5px] leading-[normal] tracking-[normal] text-left text-11xl text-[#202020] font-t1 mq700:gap-[21px] `}
    >

...
const EditPhoneModal = ({ currentPhoneNumber, onSave, onClose }) => {
  ...
  return (
    <div className="flex h-full w-full items-center justify-center fixed">
      <div
        className={`xl:max-w-[500px] text-[#202020] w-full rounded-[10px] bg-color box-border overflow-hidden flex flex-col items-start justify-start pt-[18px] px-6 pb-[23px] gap-[125px] leading-[normal] tracking-[normal] border-[1px] border-solid `}
      >
        <section className="self-stretch flex flex-col items-start justify-start gap-[40px] max-w-full text-left text-lg text-[#202020] font-l1 mq450:gap-[20px]">
          ...
          <div className="self-stretch flex flex-col items-start justify-start gap-[20px] max-w-full text-xs">
            ...
            <div className="w-[438px] flex flex-row flex-wrap items-start justify-start gap-[10px] max-w-full">
              ...
              <div className="flex-1 relative font-medium inline-block min-w-[265px] max-w-full">
                ...
                <span className="text-teal text-[#07745E]">
                  персональных данных
                </span>
              </div>
            </div>

...
export const Form1 = () => {
  ...
  return (
    <div className="mt-[150px] space-x-[10px] mx-auto flex justify-between h-[612px] pl-[65px]">
      <div>
        <h2 className="text-[30px] font-[600]">Вам нужна консультация?</h2>
        <div className=" max-w-[540px] w-full text-[16px]">
      ...
      <form
        ...
        className="flex-1 flex flex-row items-start justify-start gap-[10px] max-w-[650px] w-full h-[612px] mq1350:flex-wrap"
      >
